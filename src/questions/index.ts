...
import * as s13 from "./s13-algebra.ts";
...
import * as s18 from "./s18-functions-exponentials-logarithms.ts";
import * as s19 from "./s19-trigonometry.ts";
import * as s20 from "./s20-precalculus.ts";
...
export function makeQuestion(
  ...
  for (let reseeds = 0; reseeds < 50; reseeds++) {
    ...
    return {
      ...
      domain: draft.domain,
      figure: draft.figure,
      choices: order.map((i) => separated(three[i].text)),
